package edu.du.sb1029.board.controller;

import edu.du.sb1029.board.entity.Board;
import edu.du.sb1029.board.service.BoardService;
import edu.du.sb1029.board.validator.BoardValidator;
...
public class BoardController {
    ...
    public String insertBoard(@ModelAttribute("board") @Valid Board board, BindingResult result) throws Exception {
        if (result.hasErrors()) {
            return "board/insertForm"; // 에러가 있을 시 다시 폼 페이지로 이동
        }
